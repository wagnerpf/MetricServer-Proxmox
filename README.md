...
- **Proxmox Metric Server**: Coleta nativa de métricas (sem dependências externas)
...
┌─────────────────────────────────────────────────────────────┐
│            Proxmox VE Cluster               │
│  Metric Server (Nativo) - Coleta métricas   │
│  CPU, RAM, Disco, VMs, LXCs, Network        │
└─────────────────────────┬──────────────────┘
                     │ HTTP(S)
                     ↓
        ┌────────────────────────────┐
...
- **Proxmox VE 7.0+** (com Metric Server disponível)
- Acesso SSH/Shell ao servidor onde você rodará os containers
- Acesso ao WebUI do Proxmox para configurar Metric Server
